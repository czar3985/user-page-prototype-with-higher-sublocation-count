...
export class EditUserProfileService {
    ...
    updateUserProfile(userId: string, request: UpdateUserProfileRequest): Observable<UserProfile> {
    ...
    addAccessibleLocation(request: ToggleAccessibleLocationRequest): Observable<void> {
        return this.http.post<void>(`/users/${request.userId}/locations`, {locationId: request.locationId});
    }

    removeAccessibleLocation(request: ToggleAccessibleLocationRequest): Observable<void> {
        return this.http.delete<void>(`/users/${request.userId}/locations/${request.locationId}`);
    }
}
