...
describe('EditUserProfilePageComponent', () => {
    ...
    it('renders the edit profile title', () => {
        expect(fixture.nativeElement.textContent).toContain("Editing Avery Johnson's Profile");
    });
    it('patches profile form from loaded user', () => {
        expect(fixture.componentInstance.form.controls.email.value).toBe('avery.johnson@example.com');
    });
});
